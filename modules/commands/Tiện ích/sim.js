...
module.exports = {
  config: {
    ...
    api.sendMessage({
    body: answer && answer.includes("Tôi không biết làm thế nào để trả lời. Dạy tôi câu trả lời") ? "Tôi không hiểu bạn đang nói gì, có lẽ tôi chưa được cập nhật kiến thức :( " : answer ? answer : ''}, event.threadID, (err, info) => {
    if (err) return;
